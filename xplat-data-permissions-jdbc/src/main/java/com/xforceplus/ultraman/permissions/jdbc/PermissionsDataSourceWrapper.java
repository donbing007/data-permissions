...
public class PermissionsDataSourceWrapper implements DataSource {
    ...
    public PermissionsDataSourceWrapper(RuleCheckServiceClient client, AuthorizationSearcher authorizationSearcher,
                                        DataSource original) {
        this.client = client;
    ...
    public PermissionsDataSourceWrapper(RuleCheckServiceClient client, AuthorizationSearcher authorizationSearcher,
                                        DataSource original, VariableParserManager manager) {
        this.client = client;
        this.authorizationSearcher = authorizationSearcher;
        this.original = original;
        this.hintParser = new SQL92HintParser();
    ...
    public Connection getConnection() throws SQLException {
        ...
        return new PermissionsConnectionWrapper(client, authorizationSearcher
                , conn, hintParser, variableParserManager);
    }
