 ...
 */
public class JSqlParserUpdateSetAbilityTest {
    ...
    public Map<String, List<UpdateSet>> buildIterCase() {
        ...
        data.put("update t1 set c1=?,c2=? where id=1",
            Arrays.asList(
                new UpdateSet(new Field("c1"), JdbcParameterValue.geInstance()),
                new UpdateSet(new Field("c2"), JdbcParameterValue.geInstance())
            )
        );
