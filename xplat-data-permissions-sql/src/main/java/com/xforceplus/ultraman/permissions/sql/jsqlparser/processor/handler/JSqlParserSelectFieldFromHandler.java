 ...
 * @since 1.8
 */
public class JSqlParserSelectFieldFromHandler extends AbstractJSqlParserHandler implements FieldFromHandler {

    public JSqlParserSelectFieldFromHandler(Statement statement) {
        super(statement, Select.class);
    }

    public JSqlParserSelectFieldFromHandler(PlainSelect plainSelect) {
        super(plainSelect);
    }
    ...
    private Item findMappingField(Field source, PlainSelect select) {
        JSqlParserSelectItemHandler selectItemHandler = new JSqlParserSelectItemHandler(select);
