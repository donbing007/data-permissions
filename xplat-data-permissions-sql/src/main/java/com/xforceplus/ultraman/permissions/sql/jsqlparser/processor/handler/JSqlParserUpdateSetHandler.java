 ...
 * @since 1.8
 */
public class JSqlParserUpdateSetHandler extends AbstractJSqlParserHandler implements UpdateSetHandler {


    public JSqlParserUpdateSetHandler(Statement statement) {
