 ...
 * @since 1.8
 */
public class JSqlParserInsertValueHandler extends AbstractJSqlParserHandler implements InsertValueHandler {

    public JSqlParserInsertValueHandler(Statement statement) {
