 ...
 * @since 1.8
 */
public class JSqlParserUpdateFieldFromHandler extends AbstractJSqlParserHandler implements FieldFromHandler {
    public JSqlParserUpdateFieldFromHandler(Statement statement) {
