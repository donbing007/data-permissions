...
/**
 * 拒绝执行的 ResultSet.
 * @version 0.1 2019/11/16 23:01
 * @auth dongbin
 * @since 1.8
 */
public class DenialResultSet implements ResultSet {

    private static final DenialResultSet INSTANCE = new DenialResultSet();

    public static ResultSet getInstance() {
        return INSTANCE;
    }

    private DenialResultSet() {}
    ...
    public SQLWarning getWarnings() throws SQLException {
        return new SQLWarning("No permission to execute.","28000");
    }
